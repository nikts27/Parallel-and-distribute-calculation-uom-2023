...
def main(argv):
    ...
    print('Parallel program (having wrong use of locks though) results with {} steps' .format(numberOfSteps))
...
def calcPiForBlock(i, steps, step, num_processes, pi, lock):
    ...
    # Αναγωγή με μοιραζόμενη μεταβλητή και κλείδωμα (Λάθος! Πολλαπλά κλειδώματα)
